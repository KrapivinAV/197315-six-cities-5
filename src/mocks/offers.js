...
export default [
  {
    ...
    premium: true,
    type: `apartment`,
    rating: reviews[0].offerReviews.map((item) => item.rating).reduce((acc, currrent) => acc + currrent) / reviews[0].length,
    bedroomsQuantity: 3,
    maxAdultsQuantity: 4,
    price: 150,
    inside: [
  ...
  },
  {
    ...
    premium: false,
    type: `room`,
    rating: reviews[1].offerReviews.map((item) => item.rating).reduce((acc, currrent) => acc + currrent) / reviews[1].length,
    bedroomsQuantity: 2,
    maxAdultsQuantity: 3,
    price: 120,
    inside: [
  ...
  },
  {
    ...
    premium: true,
    type: `house`,
    rating: reviews[2].offerReviews.map((item) => item.rating).reduce((acc, currrent) => acc + currrent) / reviews[2].length,
    bedroomsQuantity: 4,
    maxAdultsQuantity: 5,
    price: 180,
    inside: [
  ...
  },
  {
    ...
    premium: false,
    type: `hotel`,
    rating: reviews[3].offerReviews.map((item) => item.rating).reduce((acc, currrent) => acc + currrent) / reviews[3].length,
    bedroomsQuantity: 1,
    maxAdultsQuantity: 2,
    price: 70,
    inside: [
