...
import FavoritesScreenOfferList from "./favorites-screen-offer-list";
...
describe(`Render FavoritesScreenOfferList`, () => {
  it(`Render FavoritesScreenOfferList`, () => {
